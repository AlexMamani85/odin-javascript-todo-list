...
import containerDOM from './Modules/DOM/containerDOM.js';
...
let todosAlone=new Project('Home')
...
let projects=[defaultProject1,defaultProject2,defaultProject1,defaultProject2,defaultProject1,defaultProject2]
...
document.body.appendChild(containerDOM(todosAlone, projects));